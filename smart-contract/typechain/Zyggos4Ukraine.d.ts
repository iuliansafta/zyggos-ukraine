...
interface Zyggos4UkraineInterface extends ethers.utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "cost()": FunctionFragment;
    "displayOwnerSupply()": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "hiddenMetadataUri()": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "maxMintAmountOwner()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "displayOwnerSupply",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "maxMintAmountOwner",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class Zyggos4Ukraine extends BaseContract {
  ...
  interface: Zyggos4UkraineInterface;
  ...
  functions: {
    ...
    displayOwnerSupply(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    maxMintAmountOwner(overrides?: CallOverrides): Promise<[BigNumber]>;
